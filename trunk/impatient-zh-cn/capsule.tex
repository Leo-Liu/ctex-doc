...
\capcs abovedisplayshortskip {当前一行适应于显示的缩进时，\TeX 在一个显示之前插入的粘连，其默认值是 0\pt\ plus 3\pt}*{}%%%FIXME
...
\capcs abovedisplayskip {当前一行不适应于显示的缩进时，\TeX 在一个显示之前插入的粘连，其默认值是 12\pt\ plus 3\pt\ minus 9\pt}*{}%%%FIXME
...
%   made}*{}
\capcs badness {生成的是后一个盒子中粘连设置的恶劣状态}*{}%%%FIXME
...
\capcs belowdisplayshortskip {当前一行适应于显示的缩进时，\TeX 在一个显示之后插入的粘连，其默认值是 7\pt\ plus 0.3\pt\ minus 4\pt}*{}%%%FIXME
...
\capcs belowdisplayskip {当前一行不适应于显示的缩进时，\TeX 在一个显示之后插入的粘连，其默认值是  12\pt\ plus 3\pt\ minus 9\pt}*{}%%%FIXME
